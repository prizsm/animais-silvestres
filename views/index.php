...
<h2>Seja bem vindo ao site da Dra. Mariana Santana!</h2>

<p>Através deste site você terá mais informações sobre biologia, manejo, alimentação, doenças e outras peculiaridades de cada espécie de animal silvestre mantidos como Pet. Aqui você conhece mais sobre o seu animail silvestre, e principalmente aprende como tratá-lo da forma correta, evitando assim a maioria das enfermidades.</p>
<p><strong>Lembre-se:</strong> <i>Nem todo médico veterinário está habilitado a atender animais silvestres, por isso, procure sempre um especialista.</i></p>
<p>Atendimento domiciliar e em clínicas conveniadas (vide links), nas regiões da Baixada Santista, ABC e Grande São Paulo. Será um prazer ajudar!</p>

<span id="noticias-recentes">
<p><strong>Últimas atualizações:</strong></p>

<ul>
<li><strong><i>AVES:</i></strong><br>
Contenção de voo de Pscitacídeos...<br>
<a href="<?php echo base_url() ?>Noticia/listarnoticia/1"><strong>Leia Mais</strong></a></li>

<li><strong><i>PEIXES:</i></strong><br>
Tópicos importantes sobre...<br>
<a href="<?php echo base_url() ?>Noticia/listarnoticia/3"><strong>Leia Mais</strong></a></li>

<li><strong><i>RÉPTEIS:</i></strong><br>
Ferimentos em Tigre d`água...<br>
<a href="<?php echo base_url() ?>Noticia/listarnoticia/4"><strong>Leia Mais</strong></a></li>
